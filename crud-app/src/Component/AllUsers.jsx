                ...
                {users.map((user) => (
                    <TableRow className={classes.row} key={user.id}>
                        ...
                        <TableCell>
                            ...
                            <Button color="secondary" variant="contained" onClick={() => deleteUserData(user._id)}><i class="fa fa-trash" style={{marginRight:5}}></i>  delete</Button> {/* change it to user.id to use JSON Server */}
                        </TableCell>
                    </TableRow>
                ))}
            </TableBody>
